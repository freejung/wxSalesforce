...
$wxSalesforce = $modx->getService('wxsalesforce','wxSalesforce',$modx->getOption('wxSalesforce.core_path',null,$modx->getOption('core_path').'components/wxsalesforce/').'model/wxsalesforce/', array('addtolists' => array(989), 'wsdl' => 'prod.wsdl'));
